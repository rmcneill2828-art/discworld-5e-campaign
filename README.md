...
- [`discworld-charter.html`](discworld-charter.html) — campaign setting primer: cosmology, geography, guilds & factions, magic systems, playable peoples, the Guild/Watch/Civilian origin system, class mapping, and adventure hooks. Also published as a [Claude Artifact](https://claude.ai/code/artifact/e274a93a-d0e7-4a77-9f98-173a41dbd61d).
- [`discworld-guild-backgrounds.html`](discworld-guild-backgrounds.html) — eight 5e RAW Backgrounds (City Watch, five Guilds, Unseen University, Civilian) with skills, tools, equipment, a feature, and roleplay prompts. Companion to the Charter's Origins system. Also published as a [Claude Artifact](https://claude.ai/code/artifact/b26f0bca-c632-4084-8d7a-f9e5981c7654).
...
- [`threats-worth-naming.html`](threats-worth-naming.html) — encounter reference: sixteen Discworld threats (a Shades tough, a Guild enforcer, a rogue golem, an Auditor of Reality, a Thing From Outside, a Noble Dragon, and more), each pointed at an unmodified 5e statblock, plus pacing and tone guidance for combat. Also published as a [Claude Artifact](https://claude.ai/code/artifact/7a980b84-0f69-4691-9d8c-cd12efaed52a).
...
- [`powers-worth-knowing.html`](powers-worth-knowing.html) — gods and the supernatural: the pantheon of Dunmanifestin, Small Gods (with a generator table), the Auditors of Reality, the Dungeon Dimensions (with a wall-thinning escalation table), swamp dragons vs. noble dragons, the Four Horsemen and other personifications, and Fairyland's elves. Descriptions and GM notes, not statblocks. Also published as a [Claude Artifact](https://claude.ai/code/artifact/1f10d0b0-b97a-4f9b-90e2-9d4bda55ea84).
...
Living document — expect additions (player character options, subclasses, one-shots) over time.
