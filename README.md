...
- [`threats-worth-naming.html`](threats-worth-naming.html) — encounter reference: fifteen Discworld threats (a Shades tough, a Guild enforcer, a rogue golem, an Auditor of Reality, a Thing From Outside, and more), each pointed at an unmodified 5e statblock, plus pacing and tone guidance for combat. Also published as a [Claude Artifact](https://claude.ai/code/artifact/7a980b84-0f69-4691-9d8c-cd12efaed52a).
